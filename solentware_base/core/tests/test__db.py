...
if berkeleydb:
    ...
    class Database_open_database(_DB):
        ...
        def test_08(self):
            ...
            self.database.open_database(berkeleydb.db, files={"file1"})
            self.check_specification()
    ...
    class Database_add_field_to_existing_database(_DB):
        ...
        def test_13_add_field_to_open_database(self):
            ...
            database.open_database(berkeleydb.db)
            self.assertEqual(
    ...
    class Database_make_recordset(_DBOpen):
        ...
        def test_56__get_segment_record_numbers(self):
            ...
            self.assertRaisesRegex(
                berkeleydb.db.DBInvalidArgError,
                r"".join(
                    (
    ...
    class Database_freed_record_number(_DBOpen):
        def setUp(self):
            ...
            self.database.ebm_control["file1"] = _db.ExistenceBitmapControl(
                "file1", self.database, berkeleydb.db, berkeleydb.db.DB_CREATE
            )
