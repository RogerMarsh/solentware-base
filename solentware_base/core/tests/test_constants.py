...
class ConstantsFunctions(unittest.TestCase):
    ...
    def test__assumptions(self):
        ...
        ae(constants.DPT_SYSFUL_FOLDER, "dptsysful")
        ae(constants.DPT_SYSCOPY_FOLDER, "dptsyscopy")
