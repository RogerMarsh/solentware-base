...
class Bitarray(unittest.TestCase):
    ...
    def setUp(self):
        self.baone = bytebit.Bitarray(1)
        self.batwo = bytebit.Bitarray(1)
        self.basix = bytebit.Bitarray(1)
        self.baten = bytebit.Bitarray(1)
        self.baall = bytebit.Bitarray(1)
...
def suite__b():
    return unittest.TestLoader().loadTestsFromTestCase(Bitarray)


if __name__ == '__main__':
    unittest.TextTestRunner(verbosity=2).run(suite__b())
