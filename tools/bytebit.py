...
"""A pure Python partial emulation of bitarray class for basesup.

The point of this module is being part of the basesup package, not a product
that has to be obtained built and intstalled separately.  Both bitarray, an
extension module written in C, and BitVector, a pure Python module, must be
...
class Bitarray(object):
    ...
    def search(self, ba, limit=None):
        """Return list of set bit positions in Bitarray. Arguments ignored.
